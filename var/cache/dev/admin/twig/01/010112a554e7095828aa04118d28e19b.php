...
class __TwigTemplate_875a807592fbe4ff315710a385e92a8c extends Template
{
...
<tr class=\"column-filters";
  ...
  ";
    ...
    >
      ";
            // line 12
            if ((CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "first", [], "any", false, false, false, 12) && (Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["grid"]) || array_key_exists("grid", $context) ? $context["grid"] : (function () { throw new RuntimeError('Variable "grid" does not exist.', 12, $this->source); })()), "actions", [], "any", false, false, false, 12), "bulk", [], "any", false, false, false, 12)) > 0))) {
                // line 13
                yield "        ";
                yield Twig\Extension\CoreExtension::include($this->env, $context, "@PrestaShop/Admin/Common/Grid/Blocks/bulk_actions_select_all.html.twig", ["grid" => (isset($context["grid"]) || array_key_exists("grid", $context) ? $context["grid"] : (function () { throw new RuntimeError('Variable "grid" does not exist.', 13, $this->source); })())]);
                yield "
      ";
            }
            // line 15
      ...
      ";
            // line 16
            if ((Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, (isset($context["grid"]) || array_key_exists("grid", $context) ? $context["grid"] : (function () { throw new RuntimeError('Variable "grid" does not exist.', 16, $this->source); })()), "filter_form", [], "any", false, false, false, 16)) > 1)) {
                // line 17
                yield "        ";
                if (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["grid"] ?? null), "column_filters", [], "any", false, true, false, 17), CoreExtension::getAttribute($this->env, $this->source, $context["column"], "id", [], "any", false, false, false, 17), [], "array", true, true, false, 17)) {
                    ...
                    yield "          ";
                    $context['_parent'] = $context;
                    $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["grid"]) || array_key_exists("grid", $context) ? $context["grid"] : (function () { throw new RuntimeError('Variable "grid" does not exist.', 18, $this->source); })()), "column_filters", [], "any", false, false, false, 18), CoreExtension::getAttribute($this->env, $this->source, $context["column"], "id", [], "any", false, false, false, 18), [], "array", false, false, false, 18));
                    foreach ($context['_seq'] as $context["_key"] => $context["filter_name"]) {
                        // line 19
                        yield "            ";
                        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["grid"]) || array_key_exists("grid", $context) ? $context["grid"] : (function () { throw new RuntimeError('Variable "grid" does not exist.', 19, $this->source); })()), "filter_form", [], "any", false, false, false, 19), $context["filter_name"], [], "array", false, false, false, 19), 'widget');
                        yield "
          ";
                    }
...
";
    ...
    {
        return array (  137 => 25,  122 => 23,  119 => 22,  116 => 21,  107 => 19,  102 => 18,  99 => 17,  97 => 16,  94 => 15,  88 => 13,  86 => 12,  81 => 10,  77 => 9,  74 => 8,  57 => 7,  51 => 6,  48 => 5,);
    }
  ...
  {% for column in grid.columns %}
    ...
    >
      {% if loop.first and grid.actions.bulk|length > 0 %}
        {{ include(\x27@PrestaShop/Admin/Common/Grid/Blocks/bulk_actions_select_all.html.twig\x27, {grid: grid}) }}
      {% endif %}
