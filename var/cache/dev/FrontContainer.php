...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    protected static function getShipmentRepositoryService($container, $lazyLoad = true)
    {
        ...
        $instance->setTablePrefix('ofefp_');
    ...
    {
        return $container->services['PrestaShop\\ModuleLibCacheDirectoryProvider\\Cache\\CacheDirectoryProvider'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('9.1.3', 'C:\\xampp\\htdocs\\prestashop', true);
    }
    ...
    {
        return $container->services['PrestaShop\\PrestaShop\\Adapter\\Shipment\\ShipmentTotalsCalculatorInterface'] = new \PrestaShop\PrestaShop\Adapter\Shipment\ShipmentTotalsCalculator(new \PrestaShop\PrestaShop\Adapter\Order\Repository\OrderRepository(($container->services['doctrine.dbal.default_connection'] ?? self::getDoctrine_Dbal_DefaultConnectionService($container)), 'ofefp_'), new \PrestaShop\PrestaShop\Adapter\Order\Repository\OrderDetailRepository(), ($container->services['PrestaShop\\PrestaShop\\Adapter\\LegacyContext'] ?? self::getLegacyContextService($container)), ($container->services['PrestaShop\\PrestaShop\\Adapter\\Tools'] ??= new \PrestaShop\PrestaShop\Adapter\Tools()));
    }
    ...
    {
        return $container->services['PsCheckout\\Cache\\FileSystem\\PayPalOrder'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('paypal-orders', 3600, ($container->services['PrestaShop\\ModuleLibCacheDirectoryProvider\\Cache\\CacheDirectoryProvider'] ??= new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('9.1.3', 'C:\\xampp\\htdocs\\prestashop', true))->getPath());
    }
    ...
    {
        return $container->services['PsCheckout\\Cache\\FileSystem\\ShippingTracking'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('shipping-tracking', 3600, ($container->services['PrestaShop\\ModuleLibCacheDirectoryProvider\\Cache\\CacheDirectoryProvider'] ??= new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('9.1.3', 'C:\\xampp\\htdocs\\prestashop', true))->getPath());
    }
    ...
    {
        return $container->services['prestashop.adapter.employee_language_updater'] = new \PrestaShop\PrestaShop\Adapter\Employee\EmployeeLanguageUpdater(($container->services['doctrine.dbal.default_connection'] ?? self::getDoctrine_Dbal_DefaultConnectionService($container)), 'ofefp_', ($container->services['PrestaShop\\PrestaShop\\Adapter\\Configuration'] ??= new \PrestaShop\PrestaShop\Adapter\Configuration())->get("PS_LANG_DEFAULT"));
    }
    ...
    {
        return $container->services['prestashop.adapter.module.repository.module_repository'] = new \PrestaShop\PrestaShop\Adapter\Module\Repository\ModuleRepository('C:\\xampp\\htdocs\\prestashop', 'C:\\xampp\\htdocs\\prestashop/modules/');
    }
    ...
    {
        return $container->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'C:\\xampp\\htdocs\\prestashop/var/cache/dev\\/localization');
    }
    ...
    {
        return $container->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy(($container->services['annotation_reader'] ??= new \Doctrine\Common\Annotations\AnnotationReader()), 'ofefp_');
    }
    ...
    {
        return $container->services['product_comment_criterion_repository'] = new \PrestaShop\Module\ProductComment\Repository\ProductCommentCriterionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)), ($container->services['doctrine.dbal.default_connection'] ?? self::getDoctrine_Dbal_DefaultConnectionService($container)), 'ofefp_');
    }
    ...
    {
        return $container->services['product_comment_repository'] = new \PrestaShop\Module\ProductComment\Repository\ProductCommentRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)), ($container->services['doctrine.dbal.default_connection'] ?? self::getDoctrine_Dbal_DefaultConnectionService($container)), 'ofefp_', ($container->services['PrestaShop\\PrestaShop\\Adapter\\Configuration'] ??= new \PrestaShop\PrestaShop\Adapter\Configuration())->get("PRODUCT_COMMENTS_ALLOW_GUESTS"), ($container->services['PrestaShop\\PrestaShop\\Adapter\\Configuration'] ??= new \PrestaShop\PrestaShop\Adapter\Configuration())->get("PRODUCT_COMMENTS_MINIMAL_TIME"));
    }
    ...
    protected static function getDotEnvLayerService($container, $lazyLoad = true)
    {
        ...
        return ($lazyLoad->__construct(($container->services['prestashop.adapter.environment'] ??= new \PrestaShop\PrestaShop\Adapter\Environment(true, 'dev', 'front')), 'C:\\xampp\\htdocs\\prestashop') && false ?: $lazyLoad);
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($b, ['C:\\xampp\\htdocs\\prestashop\\src\\PrestaShopBundle\\Entity']), 'PrestaShop');
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($b, ['C:\\xampp\\htdocs\\prestashop\\modules\\productcomments\\src\\Entity']), 'PrestaShop\\Module\\ProductComment\\Entity');
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($b, ['C:\\xampp\\htdocs\\prestashop\\modules\\psshipping\\src\\Entity']), 'PrestaShop\\Module\\Psshipping\\Entity');
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($b, ['C:\\xampp\\htdocs\\prestashop\\modules\\ps_accounts\\src\\Entity']), 'PrestaShop\\Module\\PsAccounts\\Entity');
        ...
        $instance->setProxyDir('C:\\xampp\\htdocs\\prestashop/var/cache/dev\\/doctrine/orm/Proxies');
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'prestashop.module_dir' => 'C:\\xampp\\htdocs\\prestashop/modules/',
