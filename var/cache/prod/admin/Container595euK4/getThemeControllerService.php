...
class getThemeControllerService extends AdminKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.GcEKB96'] ?? $container->load('get_ServiceLocator_GcEKB96Service'))->withContext('PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\ThemeController', $container));
