...
class getPrestashop_Core_Grid_QueryBuilder_OrderReturnStatesService extends AdminKernelProdContainer
{
    ...
    {
        return $container->services['prestashop.core.grid.query_builder.order_return_states'] = new \PrestaShop\PrestaShop\Core\Grid\Query\OrderReturnStatesQueryBuilder(($container->services['doctrine.dbal.default_connection'] ?? self::getDoctrine_Dbal_DefaultConnectionService($container)), 'ofefp_', ($container->services['PrestaShop\\PrestaShop\\Core\\Grid\\Query\\DoctrineSearchCriteriaApplicatorInterface'] ??= new \PrestaShop\PrestaShop\Core\Grid\Query\DoctrineSearchCriteriaApplicator()), ($container->services['PrestaShop\\PrestaShop\\Adapter\\LegacyContext'] ?? self::getLegacyContextService($container))->getContext()->language->id);
    }
}
