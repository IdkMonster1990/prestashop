...
$catalogue = new MessageCatalogue('en-US', array (
  ...
  array (
    ...
    'We are unable to process your Apple Pay payment at the moment. This could be due to an issue verifying the payment setup for this website. Please try again later or choose a different payment method.' => 'We are unable to process your Apple Pay payment at the moment. This could be due to an issue verifying the payment setup for this website. Please try again later or choose a different payment method.',
    ...
    'Pay by Card - Secure payments' => 'Pay by Card - Secure payments',
    'Card' => 'Card',
    ...
    'Configure' => 'Configure',
    'Warning' => 'Warning',
    'You have selected your %s PayPal account to proceed to the payment.' => 'You have selected your %s PayPal account to proceed to the payment.',
    ...
    'Contact customer service via %s' => 'Contact customer service via %s',
    'An unexpected refund error occurred.' => 'An unexpected refund error occurred.',
    'Authorization captured successfully.' => 'Authorization captured successfully.',
    'Authorization voided successfully.' => 'Authorization voided successfully.',
    'Authorization reauthorized successfully.' => 'Authorization reauthorized successfully.',
    'Not required' => 'Not required',
    'The authorization has been successfully captured.' => 'The authorization has been successfully captured.',
    'An error occurred during the capture of the authorization.' => 'An error occurred during the capture of the authorization.',
    'The currency you selected is not supported. Please try another payment method or contact support for assistance.' => 'The currency you selected is not supported. Please try another payment method or contact support for assistance.',
  ),
  ...
  array (
    ...
    'Add my IP' => 'Add my IP',
    'Add new' => 'Add new',
    'Add new API Client' => 'Add new API Client',
    ...
    'Search zip/postal code' => 'Search zip/postal code',
  ...
  array (
    ...
    'API Documentation (ReDoc)' => 'API Documentation (ReDoc)',
    ...
    'Address (2)' => 'Address (2)',
    'Admin API' => 'Admin API',
    'Admin API - Enable experimental endpoints' => 'Admin API - Enable experimental endpoints',
    'Admin API - Multistore' => 'Admin API - Multistore',
    'Age' => 'Age',
    ...
    'Both' => 'Both',
    'Both, with text format automatically generated' => 'Both, with text format automatically generated',
    ...
    'Countries' => 'Countries',
    'Create roles for your employees with specific rights. SuperAdmin can access the entire store while other people can only be dedicated to the catalog or orders pages.' => 'Create roles for your employees with specific rights. SuperAdmin can access the entire store while other people can only be dedicated to the catalog or orders pages.',
    ...
    'Debug cookie name' => 'Debug cookie name',
    'Debug cookie value' => 'Debug cookie value',
    ...
    'External issuer' => 'External issuer',
    ...
    'Force security in debug mode' => 'Force security in debug mode',
    'Generate client secret and save' => 'Generate client secret and save',
    ...
    'If you regenerate your client secret, your former secret will become obsolete.' => 'If you regenerate your client secret, your former secret will become obsolete.',
    ...
    'New front container' => 'New front container',
    ...
    'No scopes available' => 'No scopes available',
    'None' => 'None',
    ...
    'PrestaShop provides numerous APIs if you need you can see their details in the dedicated automated documentation:' => 'PrestaShop provides numerous APIs if you need you can see their details in the dedicated automated documentation:',
    ...
    'SQL query results' => 'SQL query results',
    ...
    'Select your default file separator' => 'Select your default file separator',
    ...
    'The use of multistore and Admin API is an experimental feature. You need to
        enabled the "Admin API - Multistore" functionality in' => 'The use of multistore and Admin API is an experimental feature. You need to
        enabled the "Admin API - Multistore" functionality in',
  ...
  array (
    '(Optional) Insert a cookie name to enable the debug mode only when this cookie is set.' => '(Optional) Insert a cookie name to enable the debug mode only when this cookie is set.',
    '(Optional) Insert a value to enable the debug mode only when the cookie configured above is set to this value.' => '(Optional) Insert a value to enable the debug mode only when the cookie configured above is set to this value.',
    ...
    'Admin API forces the use of HTTPS with TLSv1.2 or higher, you can disable this check for debug mode only.' => 'Admin API forces the use of HTTPS with TLSv1.2 or higher, you can disable this check for debug mode only.',
    ...
    'Before enabling the Admin API, you must be sure to:' => 'Before enabling the Admin API, you must be sure to:',
    ...
    'Check that the ps_apiressources module is installed and enabled.' => 'Check that the ps_apiressources module is installed and enabled.',
    ...
    'Check that your Admin API endpoint uses HTTPS protocol.' => 'Check that your Admin API endpoint uses HTTPS protocol.',
    ...
    'Drop existing tables during import.' => 'Drop existing tables during import.',
    'Enable / Disable the customer group page.' => 'Enable / Disable the customer group page.',
    'Enable / Disable the merchandise return page.' => 'Enable / Disable the merchandise return page.',
    'Enable / Disable the module configuration page.' => 'Enable / Disable the module configuration page.',
    'Enable / Disable the new front container.' => 'Enable / Disable the new front container.',
    'Enable / Disable the store page.' => 'Enable / Disable the store page.',
    ...
    'Enable or disable the Admin API when multistore is enabled.' => 'Enable or disable the Admin API when multistore is enabled.',
    ...
    'Error' => 'Error',
    'Experimental API endpoints are disabled by default in prod environment, this configuration allows to forcefully enable them.' => 'Experimental API endpoints are disabled by default in prod environment, this configuration allows to forcefully enable them.',
    'Fabulous' => 'Fabulous',
    ...
    'Indicate the minimum log levels that will be saved in database.' => 'Indicate the minimum log levels that will be saved in database.',
    ...
    'This FeatureFlag is forced by Env.' => 'This FeatureFlag is forced by Env.',
  ...
  array (
    ...
    '%s import' => '%s import',
    '%s is invalid. Please enter an integer between %s and %s.' => '%s is invalid. Please enter an integer between %s and %s.',
    ...
    'An error occurred while creating the API Client.' => 'An error occurred while creating the API Client.',
    ...
    'Error: The cookie name is required when the cookie value is set.' => 'Error: The cookie name is required when the cookie value is set.',
    ...
    'For security reasons, you cannot delete the Administrator\'s role.' => 'For security reasons, you cannot delete the Administrator\'s role.',
    ...
    'Product with reference %1$s (ID: %2$s) could not be saved because the product name is missing.' => 'Product with reference %1$s (ID: %2$s) could not be saved because the product name is missing.',
  ...
  array (
    ...
    'Add a customized value' => 'Add a customized value',
    ...
    'Apply to discounted products' => 'Apply to discounted products',
    ...
    'Features' => 'Features',
    'Features are your product\'s intrinsic characteristics. If you sell tee-shirts, their cotton composition is considered a feature because it remains the same, unlike colors or sizes.' => 'Features are your product\'s intrinsic characteristics. If you sell tee-shirts, their cotton composition is considered a feature because it remains the same, unlike colors or sizes.',
    ...
    'GTIN (EAN, JA, ITF or UCC code)' => 'GTIN (EAN, JA, ITF or UCC code)',
    ...
    'Label when out of stock' => 'Label when out of stock',
    ...
    'Loading feature values...' => 'Loading feature values...',
    ...
    'Redirection when not displayed' => 'Redirection when not displayed',
    ...
    '[1]Manage features[/1]' => '[1]Manage features[/1]',
  ...
  array (
    ...
    'Allowed characters: letters, numbers, underscores (_) and hyphens (-). To allow more characters, enable the \'Accented URL\' feature in Shop Parameters > Traffic & SEO.' => 'Allowed characters: letters, numbers, underscores (_) and hyphens (-). To allow more characters, enable the \'Accented URL\' feature in Shop Parameters > Traffic & SEO.',
    ...
    'By default, the closest active parent category will be used if no category is selected.' => 'By default, the closest active parent category will be used if no category is selected.',
    ...
    'Category image that is usually displayed on the category page next to description, depending on your theme.' => 'Category image that is usually displayed on the category page next to description, depending on your theme.',
    ...
    'Defines the product\'s primary placement, usually the deepest category in the hierarchy. It\'s used in breadcrumbs, URLs, structured data and many other parts of the shop.' => 'Defines the product\'s primary placement, usually the deepest category in the hierarchy. It\'s used in breadcrumbs, URLs, structured data and many other parts of the shop.',
    ...
    'Miniature image that is used when displaying subcategories. Could be also used in menus and other places, depending on your theme.' => 'Miniature image that is used when displaying subcategories. Could be also used in menus and other places, depending on your theme.',
    ...
    'Search reference' => 'Search reference',
    'Select the customer groups which will have access to this category.' => 'Select the customer groups which will have access to this category.',
    ...
    'Text that is usually displayed after the product list on category page. It\'s a good place to put longer SEO related content.' => 'Text that is usually displayed after the product list on category page. It\'s a good place to put longer SEO related content.',
    ...
    'The email will be sent to all users who have access to the Stock page. To modify permissions, go to Advanced Parameters > Team.' => 'The email will be sent to all users who have access to the Stock page. To modify permissions, go to Advanced Parameters > Team.',
    ...
    'This will be the default displayed availability of a product, if it\'s not in stock and backordering it is denied. If you don\'t enter anything, nothing will be displayed. Further customization is possible for each product.' => 'This will be the default displayed availability of a product, if it\'s not in stock and backordering it is denied. If you don\'t enter anything, nothing will be displayed. Further customization is possible for each product.',
    'This will be the default displayed availability of a product, if it\'s not in stock and backordering it is enabled. If you don\'t enter anything, nothing will be displayed. Further customization is possible for each product.' => 'This will be the default displayed availability of a product, if it\'s not in stock and backordering it is enabled. If you don\'t enter anything, nothing will be displayed. Further customization is possible for each product.',
    'This will be the default displayed availability of a product, if there is at least 1 in stock. If you don\'t enter anything, nothing will be displayed. Further customization is possible for each product.' => 'This will be the default displayed availability of a product, if there is at least 1 in stock. If you don\'t enter anything, nothing will be displayed. Further customization is possible for each product.',
    'This will be the displayed availability of the combination, if it\'s not in stock. If you don\'t enter anything, the base value set on the product will be used.' => 'This will be the displayed availability of the combination, if it\'s not in stock. If you don\'t enter anything, the base value set on the product will be used.',
    'This will be the displayed availability of the combination, if there is at least 1 in stock. If you don\'t enter anything, the base value set on the product will be used.' => 'This will be the displayed availability of the combination, if there is at least 1 in stock. If you don\'t enter anything, the base value set on the product will be used.',
    'This will be the displayed availability of the product, if it\'s not in stock. If you don\'t enter anything, value from [1]Shop Parameters > Product Settings[/1] will be used.' => 'This will be the displayed availability of the product, if it\'s not in stock. If you don\'t enter anything, value from [1]Shop Parameters > Product Settings[/1] will be used.',
    'This will be the displayed availability of the product, if there is at least 1 in stock. If you don\'t enter anything, value from [1]Shop Parameters > Product Settings[/1] will be used.' => 'This will be the displayed availability of the product, if there is at least 1 in stock. If you don\'t enter anything, value from [1]Shop Parameters > Product Settings[/1] will be used.',
    ...
    '[1]Permanent redirection (301)[/1] [2] Permanently display another category instead.' => '[1]Permanent redirection (301)[/1] [2] Permanently display another category instead.',
    ...
    '[1]Temporary redirection (302)[/1] [2] Temporarily display another category instead.' => '[1]Temporary redirection (302)[/1] [2] Temporarily display another category instead.',
  ...
  array (
    ...
    'No products has been found for this brand.' => 'No products has been found for this brand.',
    ...
    'Product "Available for order" settings is invalid.' => 'Product "Available for order" settings is invalid.',
    'Product "Low stock alert" settings is invalid.' => 'Product "Low stock alert" settings is invalid.',
    'Product "Redirection when offline" behavior is invalid.' => 'Product "Redirection when offline" behavior is invalid.',
    'Product "Redirection when offline" target is invalid.' => 'Product "Redirection when offline" target is invalid.',
    'Product "Show condition" settings is invalid.' => 'Product "Show condition" settings is invalid.',
    'Product "Show price" settings is invalid.' => 'Product "Show price" settings is invalid.',
    'Product "Web only" settings is invalid.' => 'Product "Web only" settings is invalid.',
    'Product EAN13 field is invalid.' => 'Product EAN13 field is invalid.',
    'Product GTIN field is invalid.' => 'Product GTIN field is invalid.',
    'Product ID is invalid.' => 'Product ID is invalid.',
    'Product ISBN field is invalid.' => 'Product ISBN field is invalid.',
    'Product MPN field is invalid.' => 'Product MPN field is invalid.',
    'Product UPC field is invalid.' => 'Product UPC field is invalid.',
    'Product additional shipping cost is invalid.' => 'Product additional shipping cost is invalid.',
    'Product availability date is invalid.' => 'Product availability date is invalid.',
    'Product availability label when in stock is invalid.' => 'Product availability label when in stock is invalid.',
    'Product availability label when out of stock is invalid.' => 'Product availability label when out of stock is invalid.',
    'Product condition is invalid.' => 'Product condition is invalid.',
    ...
    'Product customization fields are invalid.' => 'Product customization fields are invalid.',
    'Product delivery time when in stock are invalid.' => 'Product delivery time when in stock are invalid.',
    'Product delivery times are invalid.' => 'Product delivery times are invalid.',
    'Product delivery times when out of stock are invalid.' => 'Product delivery times when out of stock are invalid.',
    'Product depth is invalid.' => 'Product depth is invalid.',
    'Product description is invalid.' => 'Product description is invalid.',
    'Product doesn\'t have the minimum data to go online.' => 'Product doesn\'t have the minimum data to go online.',
    'Product ecotax is invalid.' => 'Product ecotax is invalid.',
    'Product file customization fields is invalid.' => 'Product file customization fields is invalid.',
    'Product friendly URL is invalid.' => 'Product friendly URL is invalid.',
    'Product height is invalid.' => 'Product height is invalid.',
    'Product low stock alert treshold is invalid.' => 'Product low stock alert treshold is invalid.',
    'Product manufacturer is invalid.' => 'Product manufacturer is invalid.',
    'Product meta description is invalid.' => 'Product meta description is invalid.',
    'Product meta title is invalid.' => 'Product meta title is invalid.',
    'Product minimum quantity for sale is invalid.' => 'Product minimum quantity for sale is invalid.',
    'Product name is invalid.' => 'Product name is invalid.',
    'Product reference is invalid.' => 'Product reference is invalid.',
    'Product short description is invalid.' => 'Product short description is invalid.',
    'Product status (active/inactive) is invalid.' => 'Product status (active/inactive) is invalid.',
    'Product tags are invalid.' => 'Product tags are invalid.',
    'Product text customization fields are invalid.' => 'Product text customization fields are invalid.',
    'Product type is invalid.' => 'Product type is invalid.',
    'Product unit in "price per unit" is invalid.' => 'Product unit in "price per unit" is invalid.',
    'Product visibility settings is invalid.' => 'Product visibility settings is invalid.',
    'Product weight is invalid.' => 'Product weight is invalid.',
    'Product wholesale price is invalid.' => 'Product wholesale price is invalid.',
    'Product width is invalid.' => 'Product width is invalid.',
    ...
    'Search phrase length is not valid.' => 'Search phrase length is not valid.',
    'Search phrase limit is not valid.' => 'Search phrase limit is not valid.',
    ...
    'The features are disabled on your store. Go to %sAdvanced Parameters > Performance%s to edit settings.' => 'The features are disabled on your store. Go to %sAdvanced Parameters > Performance%s to edit settings.',
  ...
  array (
    ...
    'JPEG images have a small file size and standard quality. PNG images have a larger file size, a higher quality and support transparency. Note that in all cases, these thumbnails will have .jpg extension.' => 'JPEG images have a small file size and standard quality. PNG images have a larger file size, a higher quality and support transparency. Note that in all cases, these thumbnails will have .jpg extension.',
    ...
    'When applying a new theme to your store, make sure that the modules you are using are still compatible.' => 'When applying a new theme to your store, make sure that the modules you are using are still compatible.',
    'Zip file' => 'Zip file',
  ...
  'AdminDesignHelp' => 
  array (
    'AVIF is disabled because it\'s not supported on your server, check your configuration if you want to use it.' => 'AVIF is disabled because it\'s not supported on your server, check your configuration if you want to use it.',
...
Once you enable the "%generate_rtl_label%" option, any RTL-specific file that you might have added to your theme might be deleted by the created stylesheet.',
    ...
    'Beware that to benefit from modern image formats, they must be supported by your theme.' => 'Beware that to benefit from modern image formats, they must be supported by your theme.',
    ...
    'Choose which image formats you want to be generated. Base image will always have .jpg extension, other formats will have .webp or .avif. Think twice before enabling all of them, because it can easily double the size of your shop.' => 'Choose which image formats you want to be generated. Base image will always have .jpg extension, other formats will have .webp or .avif. Think twice before enabling all of them, because it can easily double the size of your shop.',
    'Create meaningful content' => 'Create meaningful content',
    'E.g. address, addresses, attachment' => 'E.g. address, addresses, attachment',
    'Edit page category' => 'Edit page category',
    ...
    'Most common setup is to have the base JPG/PNG format and one modern WebP or AVIF format - the browser will choose the format it likes the most.' => 'Most common setup is to have the base JPG/PNG format and one modern WebP or AVIF format - the browser will choose the format it likes the most.',
    ...
    'The original images of objects you create are almost never used, optimized thumbnails are used instead. In this section, you can define the formats of thumbnails and their quality.' => 'The original images of objects you create are almost never used, optimized thumbnails are used instead. In this section, you can define the formats of thumbnails and their quality.',
  ...
  array (
    ...
    'Always' => 'Always',
    'Amount' => 'Amount',
    'Api Client: %api_client_id%' => 'Api Client: %api_client_id%',
    ...
    'Ascending' => 'Ascending',
    'Attribute' => 'Attribute',
    'Attribute Group ID' => 'Attribute Group ID',
    'Attributes' => 'Attributes',
    'Available' => 'Available',
    ...
    'Created from cart' => 'Created from cart',
    ...
    'Use prefix for default language' => 'Use prefix for default language',
    'Value' => 'Value',
    'Values' => 'Values',
    'Version' => 'Version',
    'View' => 'View',
  ...
  array (
    ...
    'Country contains invalid field values.' => 'Country contains invalid field values.',
    ...
    'Failed to update country.' => 'Failed to update country.',
    'Failed to update country. An unexpected error occurred.' => 'Failed to update country. An unexpected error occurred.',
    'Flag' => 'Flag',
    ...
    'This country does not exist.' => 'This country does not exist.',
  ...
  array (
    ...
    'IETF language tag (e.g. en-us, pt-br) in lower case.' => 'IETF language tag (e.g. en-us, pt-br) in lower case.',
  ...
  array (
    ...
    'If you switch from a single-language shop to a multi-language setup, be aware that URLs may change depending on your URL settings.' => 'If you switch from a single-language shop to a multi-language setup, be aware that URLs may change depending on your URL settings.',
    'Important information regarding languages:' => 'Important information regarding languages:',
    ...
    'When you delete a language, all content for all objects related to that language will be permanently removed from the database.' => 'When you delete a language, all content for all objects related to that language will be permanently removed from the database.',
  ...
  array (
    ...
    'You have been logged out for security reasons' => 'You have been logged out for security reasons',
  ),
  ...
  array (
    ...
    '%d file update applied' => '%d file update applied',
    '%d update left' => '%d update left',
    ...
    'Are you sure you want to update these modules?' => 'Are you sure you want to update these modules?',
    'Are you sure you want to update this module?' => 'Are you sure you want to update this module?',
    ...
    'Installing module...' => 'Installing module...',
    'It will close as soon as the module is installed. It won\'t be long!' => 'It will close as soon as the module is installed. It won\'t be long!',
    'Module %s cannot be updated this time: please refresh this page to update it.' => 'Module %s cannot be upgraded this time: please refresh this page to update it.',
    'Module %s has no getContent() method' => 'Module %s has no getContent() method',
    'Module deleted successfully.' => 'Module deleted successfully.',
    'Module installed successfully: %s v%s' => 'Module installed successfully: %s v%s',
    'Module installed!' => 'Module installed!',
    'Module reset successfully.' => 'Module reset successfully.',
    'Module uninstalled successfully: %s v%s' => 'Module uninstalled successfully: %s v%s',
    'Module upgraded successfully: %s to v%s' => 'Module upgraded successfully: %s to v%s',
    ...
    'No update has been applied' => 'No update has been applied',
    'Oops... Upload failed.' => 'Oops... Upload failed.',
    ...
    'Starting module install: %s v%s' => 'Starting module install: %s v%s',
    'Starting module uninstall: %s v%s' => 'Starting module uninstall: %s v%s',
    'Starting module upgrade: %s v%s to v%s' => 'Starting module upgrade: %s v%s to v%s',
    ...
    'The module "%modulename%" cannot be found' => 'The module "%modulename%" cannot be found',
    'The module %module% is invalid and cannot be loaded.' => 'The module %module% is invalid and cannot be loaded.',
    ...
    'Unfortunately, the module %module% did not return additional details.' => 'Unfortunately, the module %module% did not return additional details.',
    ...
    'Updated from: %s to %s' => 'Updated from: %s to %s',
    'Validation of configuration details failed:' => 'Validation of configuration details failed:',
    'We strongly advise you to update the modules on maintenance mode to avoid any cache issues.' => 'We strongly advise you to update the modules on maintenance mode to avoid any cache issues.',
    ...
    'You are not allowed to update the module %module%.' => 'You are not allowed to update the module %module%.',
    'You are not allowed to upload modules.' => 'You are not allowed to upload modules.',
  ...
  array (
    ...
    'Customer sessions' => 'Customer sessions',
    'Customer settings' => 'Customer settings',
    'Customer thread #%s' => 'Customer thread #%s',
    'Customers' => 'Customers',
    'DB Backup' => 'DB Backup',
    ...
    'Design' => 'Design',
    'Discounts' => 'Discounts',
    'Downloading backup %s' => 'Downloading backup %s',
    'E-mail' => 'E-mail',
    'Editing %lastname% %firstname%\'s profile' => 'Editing %lastname% %firstname%\'s profile',
    'Editing %name%' => 'Editing %name%',
    'Editing %role_name% role' => 'Editing %role_name% role',
    'Editing API Client "%name%"' => 'Editing API Client "%name%"',
    'Editing SQL query %query%' => 'Editing SQL query %query%',
    'Editing address %alias%' => 'Editing address %alias%',
    'Editing attribute %name%' => 'Editing attribute %name%',
    'Editing attribute value %name%' => 'Editing attribute value %name%',
    'Editing brand %name%' => 'Editing brand %name%',
    'Editing brand address' => 'Editing brand address',
    'Editing carrier %name%' => 'Editing carrier %name%',
    'Editing category %category_name%' => 'Editing category %category_name%',
    'Editing category %name%' => 'Editing category %name%',
    'Editing configuration for %name%' => 'Editing configuration for %name%',
    ...
    'Editing file %value%' => 'Editing file %value%',
    'Editing language %name%' => 'Editing language %name%',
    'Editing message %s' => 'Editing message %s',
    'Editing order status %name%' => 'Editing order status %name%',
    'Editing page %name%' => 'Editing page %name%',
    'Editing price rule %name%' => 'Editing price rule %name%',
    'Editing return status %name%' => 'Editing return status %name%',
    'Editing search engine %name%' => 'Editing search engine %name%',
    'Editing state %value%' => 'Editing state %value%',
    'Editing supplier %name%' => 'Editing supplier %name%',
    'Editing tax %name%' => 'Editing tax %name%',
    'Editing tax rule %value%' => 'Editing tax rule %value%',
    'Editing webservice key %key%' => 'Editing webservice key %key%',
    ...
    'New Feature Value' => 'New Feature Value',
    'New SQL query' => 'New SQL query',
    'New address' => 'New address',
    'New attribute' => 'New attribute',
    'New attribute value' => 'New attribute value',
    'New brand' => 'New brand',
    'New brand address' => 'New brand address',
    'New catalog rule' => 'New catalog rule',
    'New category' => 'New category',
    ...
    'New order' => 'New order',
    'New order message' => 'New order message',
    'New order status' => 'New order status',
    'New page' => 'New page',
    'New page configuration' => 'New page configuration',
    'New return status' => 'New return status',
    'New role' => 'New role',
    'New state' => 'New state',
    'New supplier' => 'New supplier',
    'New tax' => 'New tax',
    'New tax rule' => 'New tax rule',
    'New webservice key' => 'New webservice key',
    'New zone' => 'New zone',
    ...
    'Previewing theme %s' => 'Previewing theme %s',
    'Product Settings' => 'Product Settings',
    'Product settings' => 'Product settings',
    'Products' => 'Products',
    'Quick Access' => 'Quick Access',
    'Referrers' => 'Referrers',
    'Result of SQL query' => 'Result of SQL query',
    ...
    'Webservice keys' => 'Webservice keys',
    'Zones' => 'Zones',
  ),
  ...
  array (
    ...
    'To manage the maintenance settings, go to Shop Parameters > Maintenance tab.' => 'To manage the maintenance settings, go to Shop Parameters > Maintenance tab.',
  ...
  array (
    ...
    '%s is invalid. Please enter an integer between 0 and %s.' => '%s is invalid. Please enter an integer between 0 and %s.',
    ...
    'Attribute color is invalid ' => 'Attribute color is invalid ',
    'Attribute group is invalid' => 'Attribute group is invalid',
    'Attribute name is invalid' => 'Attribute name is invalid',
    'Authorization not allowed for all stores.' => 'Authorization not allowed for all stores.',
    'Authorization not allowed for this group of stores.' => 'Authorization not allowed for this group of stores.',
    'Authorization not allowed for this store context.' => 'Authorization not allowed for this store context.',
    'Authorization not allowed for this store.' => 'Authorization not allowed for this store.',
    ...
    'Graph module could not be loaded.' => 'Graph module could not be loaded.',
    'Grid module could not be loaded.' => 'Grid module could not be loaded.',
    ...
    'Link to database cannot be established: %s' => 'Link to database cannot be established: %s',
    ...
    'PrestaShop Fatal error: no utf-8 support. Please check your server configuration.' => 'PrestaShop Fatal error: no utf-8 support. Please check your server configuration.',
    ...
    'Role(s) assigned to employee cannot be deleted' => 'Role(s) assigned to employee cannot be deleted',
    ...
    'The field "%field%" cannot be longer than %limit% characters.' => 'The field "%field%" cannot be longer than %limit% characters.',
    ...
    'The page you\'re looking for could not be found. This might be due to a typo in the URL, an outdated link, or because the page was part of a module that is no longer installed.' => 'The page you\'re looking for could not be found. This might be due to a typo in the URL, an outdated link, or because the page was part of a module that is no longer installed.',
    ...
    'The selected default page is not accessible by the selected profile.' => 'The selected default page is not accessible by the selected profile.',
    ...
    'This cart rule code is already used' => 'This cart rule code is already used',
    ...
    'This field is required.' => 'This field is required.',
    'This field must be between %min% and %max%' => 'This field must be between %min% and %max%',
    ...
    'This value for "%field%" is already used and must be unique.' => 'This value for "%field%" is already used and must be unique.',
    ...
    'You cannot delete your own role' => 'You cannot delete your own role',
  ...
  array (
    ...
    'Invalid characters:' => 'Invalid characters:',
    'Invalid characters: %chars%' => 'Invalid characters: %chars%',
    ...
    'This secret value will only be displayed once. Don\'t forget to make a copy in a secure location.' => 'This secret value will only be displayed once. Don\'t forget to make a copy in a secure location.',
    'You have been automatically switched to your default store.' => 'You have been automatically switched to your default store.',
  ),
  ...
  array (
    ...
    'The API Client and client secret have been generated successfully.' => 'The API Client and client secret have been generated successfully.',
    ...
    'The status of the selection has been successfully updated.' => 'The status of the selection has been successfully updated.',
    ...
    'Your new client secret has been generated successfully. Your former client secret is now obsolete.' => 'Your new client secret has been generated successfully. Your former client secret is now obsolete.',
  ...
  array (
    ...
    '%firstname% %lastname% did not create any cart yet' => '%firstname% %lastname% did not create any cart yet',
    ...
    'Customer private note' => 'Customer private note',
    'Customer since: %s' => 'Customer since: %s',
    'Customer thread #%id%' => 'Customer thread #%id%',
    'Customer type' => 'Customer type',
    'Customers' => 'Customers',
    'Date' => 'Date',
    ...
    'Free shipping' => 'Free shipping',
    'From' => 'From',
    'From %date1% to %date2% per unique visitors' => 'From %date1% to %date2% per unique visitors',
...
Best regards,',
    ...
    'Order messages' => 'Order messages',
    'Order private note' => 'Order private note',
    'Order status' => 'Order status',
  ...
  array (
    ...
    'Quick customers with no password, who don\'t have access to the privileges of registered ones. You can create as many guests as needed using the same email. It could be helpful if you take phone call orders.' => 'Quick customers with no password, who don\'t have access to the privileges of registered ones. You can create as many guests as needed using the same email. It could be helpful if you take phone call orders.',
  ...
  array (
    ...
    'You can transform this guest to a registered customer. The customer will receive an email with a link to set a password.' => 'You can transform this guest to a registered customer. The customer will receive an email with a link to set a password.',
    'You can\'t create a registered customer with email "%s", because a registered customer with this email already exists.' => 'You can\'t create a registered customer with email "%s", because a registered customer with this email already exists.',
    'You can\'t transform this guest to a registered customer, because a registered customer with this email address already exists. ' => 'You can\'t transform this guest to a registered customer, because a registered customer with this email address already exists. ',
    'You can\'t update the email to "%s", because a registered customer with this email already exists.' => 'You can\'t update the email to "%s", because a registered customer with this email already exists.',
  ...
  array (
    ...
    'Based on the order\'s total price' => 'Based on the order\'s total price',
    'Based on the order\'s total weight' => 'Based on the order\'s total weight',
    'Billing' => 'Billing',
    'Carrier' => 'Carrier',
    ...
    'For compatibility reasons, the original version remains enabled on your shop. If no incompatible modules are holding you back, feel free to switch to the new version. The legacy version will eventually be removed in a future release.' => 'For compatibility reasons, the original version remains enabled on your shop. If no incompatible modules are holding you back, feel free to switch to the new version. The legacy version will eventually be removed in a future release.',
    'Free Shipping' => 'Free Shipping',
    'Free shipping' => 'Free shipping',
    ...
    'Make sure there are no overlapping ranges. Remember, the minimum is part of the range, but the maximum isn\'t. So, the upper limit of a range is the lower limit of the next range.' => 'Make sure there are no overlapping ranges. Remember, the minimum is part of the range, but the maximum isn\'t. So, the upper limit of a range is the lower limit of the next range.',
    'Manage ranges' => 'Manage ranges',
    'Manage your carriers' => 'Manage your carriers',
    'Max order depth' => 'Max order depth',
    'Max order height' => 'Max order height',
    'Max order weight' => 'Max order weight',
    'Max order width' => 'Max order width',
    'Maximum' => 'Maximum',
    ...
    'Please upload a valid jpeg file' => 'Please upload a valid jpeg file',
    'Price (VAT excl.)' => 'Price (VAT excl.)',
    'Range' => 'Range',
    'Ranges' => 'Ranges',
    'Set ranges and prices' => 'Set ranges and prices',
    'Shipping and handling' => 'Shipping and handling',
    'Shipping cost' => 'Shipping cost',
    'Shipping costs' => 'Shipping costs',
    'Shipping locations and costs' => 'Shipping locations and costs',
    'Shipping size and weight' => 'Shipping size and weight',
    'Size and weight' => 'Size and weight',
    'Size, weight, and group access' => 'Size, weight, and group access',
    'Speed grade' => 'Speed grade',
    'Tax' => 'Tax',
    'The file is too large. Allowed maximum size is 8MB.' => 'The file is too large. Allowed maximum size is 8MB.',
    ...
    'You can not add a negative range' => 'You can not add a negative range',
    'Zones' => 'Zones',
    '[1]A new, improved version of this page is ready.[/1] You can enable it with a single click in the [2]New & Experimental Features[/2] section.' => '[1]A new, improved version of this page is ready.[/1] You can enable it with a single click in the [2]New & Experimental Features[/2] section.',
    '[1]Manage handling costs[/1]' => '[1]Manage handling costs[/1]',
    '[1]Manage locations[/1]' => '[1]Manage locations[/1]',
    '[1]Manage taxes[/1]' => '[1]Manage taxes[/1]',
  ...
  array (
    ...
    'Does the carrier have additional fees' => 'Does the carrier have additional fees',
    ...
    'Maximum depth managed by this carrier. Set the value to "0" to ignore.' => 'Maximum depth managed by this carrier. Set the value to "0" to ignore.',
    ...
    'Maximum depth managed by this carrier. Set the value to "0," or leave this field blank to ignore.' => 'Maximum depth managed by this carrier. Set the value to "0," or leave this field blank to ignore.',
    'Maximum height managed by this carrier. Set the value to "0" to ignore.' => 'Maximum height managed by this carrier. Set the value to "0" to ignore.',
    ...
    'Maximum height managed by this carrier. Set the value to "0," or leave this field blank to ignore.' => 'Maximum height managed by this carrier. Set the value to "0," or leave this field blank to ignore.',
    'Maximum weight managed by this carrier. Set the value to "0" to ignore.' => 'Maximum weight managed by this carrier. Set the value to "0" to ignore.',
    ...
    'Maximum weight managed by this carrier. Set the value to "0," or leave this field blank to ignore.' => 'Maximum weight managed by this carrier. Set the value to "0," or leave this field blank to ignore.',
    'Maximum width managed by this carrier. Set the value to "0" to ignore.' => 'Maximum width managed by this carrier. Set the value to "0" to ignore.',
    ...
    'Zones that the carrier can handle' => 'Zones that the carrier can handle',
    'or' => 'or',
    'undefined' => 'undefined',
  ),
  ...
  array (
    ...
    'Add new return status' => 'Add new return status',
    ...
    'Category the product was accessed from' => 'Category the product was accessed from',
    'Category used in breadcrumbs' => 'Category used in breadcrumbs',
...
Customer service',
    ...
    'Display notifications if the product is already in the cart' => 'Display notifications if the product is already in the cart',
    ...
    'Don\'t display this status to the customer on order tracking page.' => 'Don\'t display this status to the customer on order tracking page.',
    'Edit aliases for %s' => 'Edit aliases for %s',
    ...
    'Failed to delete alias.' => 'Failed to delete alias.',
    ...
    'Generate an invoice when order is assigned this status.' => 'Generate an invoice when order is assigned this status.',
    ...
    'Maximum acceptable word difference' => 'Maximum acceptable word difference',
    ...
    'Order of feature values' => 'Order of feature values',
    'Order status' => 'Order status',
    'Other' => 'Other',
    'Out-of-Stock' => 'Out-of-Stock',
    'Page' => 'Page',
    ...
    'Product default category' => 'Product default category',
    ...
    'Set the associated order as delivered.' => 'Set the associated order as delivered.',
    'Set the associated order as paid.' => 'Set the associated order as paid.',
    'Set the associated order as shipped.' => 'Set the associated order as shipped.',
    'Set the associated order as validated.' => 'Set the associated order as validated.',
    ...
    'Set up a new page' => 'Set up a new page',
    ...
    'Show prices:' => 'Show prices:',
    'Social title' => 'Social title',
    'Some alias are already in use for another search term: %s.' => 'Some alias are already in use for another search term: %s.',
    ...
    'This option allows you to choose which image to display in listings for products with combinations. By default, the cover image of the product will be used. If you enable this option and your filtering module is properly passing the required information, then the default image of the combination found will be displayed.' => 'This option allows you to choose which image to display in listings for products with combinations. By default, the cover image of the product will be used. If you enable this option and your filtering module is properly passing the required information, then the default image of the combination found will be displayed.',
    'Thursday' => 'Thursday',
    'Titles' => 'Titles',
    'Tuesday' => 'Tuesday',
    'Undefined' => 'Undefined',
    ...
    'Use combination image in listings' => 'Use combination image in listings',
    'Visitor' => 'Visitor',
    'Visitors' => 'Visitors',
...
Thanks for your patience.',
  ...
  array (
    ...
    'Background color of this status label. Used both in backoffice and on order tracking page. HTML colors only.' => 'Background color of this status label. Used both in backoffice and on order tracking page. HTML colors only.',
    ...
    'If order\'s invoice is not generated yet, this will generate it.' => 'If order\'s invoice is not generated yet, this will generate it.',
    ...
    'If you own an SSL certificate for your shop\'s domain name, you can activate SSL encryption (https://) for all the pages of your shop.' => 'If you own an SSL certificate for your shop\'s domain name, you can activate SSL encryption (https://) for all the pages of your shop.',
    ...
    'If your customer already has this product in their cart, a notification will be displayed on top of the product page. The customer will also be notified if the product they are browsing is part of a pack that\'s in their cart.' => 'If your customer already has this product in their cart, a notification will be displayed on top of the product page. The customer will also be notified if the product they are browsing is part of a pack that\'s in their cart.',
    'Image height in pixels. Enter "0" to use the original size.' => 'Image height in pixels. Enter "0" to use the original size.',
    'Image of this status used in the backoffice. (File type: .gif, suggested size: 16x16).' => 'Image of this status used in the backoffice. (File type: .gif, suggested size: 16x16).',
    'Image width in pixels. Enter "0" to use the original size.' => 'Image width in pixels. Enter "0" to use the original size.',
    'In stock' => 'In stock',
    'In the product page, feature values can be sorted alphabetically by value or by position.' => 'In the product page, feature values can be sorted alphabetically by value or by position.',
    ...
    'Select an email template that will be sent after setting this status.' => 'Select an email template that will be sent after setting this status.',
    'Select which category to display on the product page breadcrumbs. It can be the product\'s default category or the category the customer came from.' => 'Select which category to display on the product page breadcrumbs. It can be the product\'s default category or the category the customer came from.',
    ...
    'This option defines how much different can the alternative words found by fuzzy search be. Or, how many characters can be different/missing/added. The default value is 5.' => 'This option defines how much different can the alternative words found by fuzzy search be. Or, how many characters can be different/missing/added. The default value is 5.',
    ...
    'This will add an entry to order\'s "Payments" table, if it doesn\'t exist yet.' => 'This will add an entry to order\'s "Payments" table, if it doesn\'t exist yet.',
    'This will attach delivery slip PDF to the sent email, if it exists. If it doesn\'t, it will have no effect.' => 'This will attach delivery slip PDF to the sent email, if it exists. If it doesn\'t, it will have no effect.',
    'This will attach invoice PDF to the sent email, if it exists. If it doesn\'t, it will have no effect.' => 'This will attach invoice PDF to the sent email, if it exists. If it doesn\'t, it will have no effect.',
    'This will create a delivery slip and mark a delivery date on order\'s invoice.' => 'This will create a delivery slip and mark a delivery date on order\'s invoice.',
    'This will mark the order as shipped. It will register a stock movement entry, prevent modifying the order and other things.' => 'This will mark the order as shipped. It will register a stock movement entry, prevent modifying the order and other things.',
    'This will mark the order as successfuly processed - including it in customer\'s revenue, your shop stats etc.' => 'This will mark the order as successfuly processed - including it in customer\'s revenue, your shop stats etc.',
    'This will send an email to the customer after assigning this status. Make sure to select proper email template below.' => 'This will send an email to the customer after assigning this status. Make sure to select proper email template below.',
    ...
    'Use this if you want this status to be internal only.' => 'Use this if you want this status to be internal only.',
  ...
  array (
    ...
    'Only available keywords for a given route can be used' => 'Only available keywords for a given route can be used',
  ...
  array (
    ...
    'The admin folder could not be renamed into %folderName%' => 'The admin folder could not be renamed into %folderName%',
  ...
  array (
    'Includes the resources allowing using the API for the PrestaShop domain, all endpoints are based on CQRS commands/queries from the Core and we APIPlatform framework is used as a base.' => 'Includes the resources allowing using the API for the PrestaShop domain, all endpoints are based on CQRS commands/queries from the Core and we APIPlatform framework is used as a base.',
    'PrestaShop API Resources' => 'PrestaShop API Resources',
  ),
  ...
  array (
    ...
    'You have chosen payment by check.' => 'You have chosen payment by check.',
    'Your check must include following details:' => 'Your check must include following details:',
  ...
  array (
    ...
    'Interested in this product? Click below and we will let you know when it\'s available for order.' => 'Interested in this product? Click below and we will let you know when it\'s available for order.',
    'Interested in this product? Drop us an email and we will let you know when it\'s available for order.' => 'Interested in this product? Drop us an email and we will let you know when it\'s available for order.',
    'My alerts' => 'My alerts',
  ...
  array (
    ...
    'Please send us a bank transfer with following details:' => 'Please send us a bank transfer with following details:',
    ...
    'You have chosen payment by bank transfer.' => 'You have chosen payment by bank transfer.',
    'Your order on %s is complete.' => 'Your order on %s is complete.',
  ...
  array (
    ...
    'The %1$s field is too long (%2$d chars max).' => 'The %1$s field is too long (%2$d chars max).',
    'The %1$s field is too short (%2$d chars min).' => 'The %1$s field is too short (%2$d chars min).',
    ...
    'This category is no longer available.' => 'This category is no longer available.',
    ...
    'This voucher is not valid.' => 'This voucher is not valid.',
  ...
  array (
    ...
    'Back to Shipping method' => 'Back to Shipping method',
    'Back to login' => 'Back to login',
    ...
    'Continue to Addresses' => 'Continue to Addresses',
    ...
    'add new address' => 'add new address',
    'edit' => 'edit',
    'has been removed from the cart.' => 'has been removed from the cart.',
  ...
  array (
    '%1$s:' => '%1$s:',
    '%1s of these products are included in packs in your cart.' => '%1s of these products are included in packs in your cart.',
    ...
    'If this is a recurring problem, please [1]contact us[/1]' => 'If this is a recurring problem, please [1]contact us[/1]',
    'Image' => 'Image',
    'In stock' => 'In stock',
    'Including %amount% for ecotax' => 'Including %amount% for ecotax',
    'Instead of %price%' => 'Instead of %price%',
    'It can not be reached anymore. Can we still attract you into our shop?' => 'It can not be reached anymore. Can we still attract you into our shop?',
    'Item' => 'Item',
    'Items' => 'Items',
    ...
    'No search results for "%search_term%"' => 'No search results for "%search_term%"',
    'No supplier' => 'No supplier',
    'No tax' => 'No tax',
    ...
    'Product image %number%' => 'Product image %number%',
    ...
    'Suppliers' => 'Suppliers',
    'The page you are looking for is no longer available' => 'The page you are looking for is no longer available',
    ...
    'Your cart contains %1s of these products and another %2s of these are included in packs in your cart.' => 'Your cart contains %1s of these products and another %2s of these are included in packs in your cart.',
    'Your cart contains %1s of these products.' => 'Your cart contains %1s of these products.',
  ...
  array (
    ...
    'Next: Shipping Method' => 'Next: Shipping Method',
    ...
    'Paste your voucher here' => 'Paste your voucher here',
    'Payment' => 'Payment',
    ...
    'Value' => 'Value',
    'View cart (%d products)' => 'View cart (%d products)',
    'Weight' => 'Weight',
    'Write a comment about this order' => 'Write a comment about this order',
  ...
  array (
    ...
    'Not you? [1]Sign out[/1]' => 'Not you? [1]Sign out[/1]',
    'Order' => 'Order',
    ...
    'View my account (%s)' => 'View my account (%s)',
  ...
  array (
    ...
    'Virtual product, no delivery service.' => 'Virtual product, no delivery service.',
